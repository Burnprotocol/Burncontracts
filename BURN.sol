...
contract BURN is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "BURNTEST";
    string private _symbol = "BURNTEST";
    ...
    function includeInReward(address account) external onlyOwner() {
      ...
      function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
        _tOwned[recipient] = _tOwned[recipient].add(finalRTransferAmount);
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function updateJackpotDetails(uint256 totalAmount, uint256 jackpotAmount, uint256 _rID, address _winner) private {
        ...
        /*****SECOND update the jackpot details*****/
        ...
        //check if there is a need to start the new round
    ...
    uint256  private rndInc = 1 seconds;  // every BURN transacted adds this much to the timer
    uint256  private rndMax =  6 hours;
    ...
    function setTimeAddForJackpot(uint256 _time) public onlyOwner(){
        rndInc = _time;
    }
    
    function setMAxTimeForJackpot(uint256 _time) public onlyOwner(){
        rndMax = _time;
    }
